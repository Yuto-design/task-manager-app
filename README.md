...
フロントエンド・サーバ・インフラ・CI の構成は [docs/architecture.md](docs/architecture.md) にまとめています。

* システム全体構成図（Docker / Nginx / PHP-FPM / MySQL）
* アプリケーション層の詳細（Blade・JS モジュール・ルート・Controller・Service・Repository・モデル）
* データフロー（タスク一覧取得のシーケンス）
